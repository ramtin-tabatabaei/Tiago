...
def rotate_and_tilt_head(pan_degrees, tilt_degrees):
    ...
    point.time_from_start = rospy.Duration(1)  # Adjust the duration as needed for your setup
...
def run():
    ...
    rotate_and_tilt_head(0, -40)  # Note: Assuming negative tilt means downwards
