...
def update_gripper_position(increment):
    ...
    new_position = [max(0.03, min(1, pos)) for pos in new_position]
...
def run():
    ...
    X, Y= 0.6612406098384724, -0.25126829903122916
    ...
    goal_position = [X_Poly, Y_3D, -0.2]  # Adjust as needed

    goal_orientation = [0, 0, yaw+pi*2/2]  # Adjust as needed
